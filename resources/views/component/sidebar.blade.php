<div class="sidebar-menu">
  ...
  <div class="menu">
      <ul id="menu">
          ...
          <li><a href="/add"><i class="fa fa-cogs"></i><span>Components</span><span class="fa fa-angle-right"
                      style="float: right"></span></a>
              <ul>
                  <li><a href="/create">Data Dosen</a></li>
                  <li><a href="/tambah">Portlets</a></li>
              </ul>
          </li>
          <li id="menu-comunicacao"><a href="/tambah"><i class="fa fa-book nav_icon"></i><span>Asdos</span><span
                      class="fa fa-angle-right" style="float: right"></span></a>
              <ul id="menu-comunicacao-sub">
                  <li id="menu-mensagens" style="width: 120px"><a href="/create">Data Asdos</a>
                  </li>
